 ...
 */
export declare class LitePay extends PayBaseX {
    /**
     * 统一下单
     *
     * ```
     ...
     */
    unifiedOrder(options: types.UnifiedOrderOptionsLite): Promise<types.SuccessT<types.UnifiedOrderResponseSuccess> | types.FailT<types.UnifiedOrderResponseFail>>;
}
