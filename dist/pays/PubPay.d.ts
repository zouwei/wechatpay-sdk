 ...
 */
export declare class PubPay extends PayBaseX {
    /**
     * 统一下单
     *
     * ```
     ...
     */
    unifiedOrder(options: types.UnifiedOrderOptionsPub): Promise<types.SuccessT<types.UnifiedOrderResponseSuccess> | types.FailT<types.UnifiedOrderResponseFail>>;
}
