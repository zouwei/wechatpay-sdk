 ...
 */
export declare class AppPay extends PayBaseX {
    /**
     * 统一下单
     *
     * ```
     ...
     */
    unifiedOrder(options: types.UnifiedOrderOptionsApp): Promise<types.SuccessT<types.UnifiedOrderResponseSuccess> | types.FailT<types.UnifiedOrderResponseFail>>;
}
