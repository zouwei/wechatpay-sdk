 ...
 */
export declare class WapPay extends PayBaseX {
    /**
     * 统一下单
     *
     * ```
     ...
     */
    unifiedOrder(options: types.UnifiedOrderOptionsWap): Promise<types.SuccessT<types.UnifiedOrderResponseSuccess> | types.FailT<types.UnifiedOrderResponseFail>>;
}
