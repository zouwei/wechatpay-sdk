 ...
 */
export declare class PubQrPay extends PayBaseX {
    /**
     * 统一下单
     *
     * ```
     ...
     */
    unifiedOrder(options: types.UnifiedOrderOptionsPubQr): Promise<types.SuccessT<types.UnifiedOrderResponseSuccess> | types.FailT<types.UnifiedOrderResponseFail>>;
}
