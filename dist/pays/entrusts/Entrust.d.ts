 ...
 * ```
 */
export declare class Entrust extends EntrustBase {
    /**
     * 支付中签约
     *
     * ```
     ...
     * ```
     */
    contractOrder(options: types.ContractOrderOptions, tradeType: string): Promise<types.SuccessT<types.ContractOrderResponseSuccess> | types.FailT<types.ContractOrderResponseFail>>;
    /**
     * 纯签约
     *
     * ```
     ...
     * ```
     */
    entrust(options: types.EntrustAppOptions | types.EntrustLiteOptions | types.EntrustPubOptions | types.EntrustWapOptions): Promise<any>;
}
