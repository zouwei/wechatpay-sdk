 ...
 */
export declare class PubEntrust extends EntrustBase {
    /**
     * 支付中签约
     *
     * ```
     ...
     */
    contractOrder(options: types.ContractOrderOptions): Promise<types.SuccessT<types.ContractOrderResponseSuccess> | types.FailT<types.ContractOrderResponseFail>>;
    /**
     * 纯签约
     *
     * ```
     ...
     * @see {@link https://pay.weixin.qq.com/wiki/doc/api/pap.php?chapter=18_1&index=1}
     */
    entrust(options: types.EntrustPubOptions): Promise<string>;
}
