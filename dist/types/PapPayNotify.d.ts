...
export declare type PapPayNotifySuccess = SuccessT<PapPayNotifyOptionsSuccess>;
export declare type PapPayNotifyFail = FailT<PapPayNotifyOptionsFail>;
export declare type PapPayNotifyHandler = (data: PapPayNotifySuccess | PapPayNotifyFail) => Promise<BaseReturn>;
