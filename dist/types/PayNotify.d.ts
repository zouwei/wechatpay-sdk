...
export declare type PayNotifySuccess = SuccessT<PayNotifyOptionCommon>;
export declare type PayNotifyFail = FailT<PayNotifyOptionCommon>;
export declare type PayNotifyHandler = (data: PayNotifySuccess | PayNotifyFail) => Promise<BaseReturn>;
