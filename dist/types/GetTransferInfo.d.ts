...
export declare type GetTransferInfoSuccess = SuccessT<GetTransferInfoResponseSuccess>;
export declare type GetTransferInfoFail = FailT<GetTransferInfoResponseFail>;
