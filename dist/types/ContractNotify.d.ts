...
export declare type ContractNotifySuccess = SuccessT<ContractNotifyOptionsSuccess>;
export declare type ContractNotifyFail = FailT<ContractNotifyOptionsFail>;
export declare type ContractNotifyHandler = (data: ContractNotifySuccess | ContractNotifyFail) => Promise<BaseReturn>;
