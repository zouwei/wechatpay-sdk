...
export interface QueryCouponStockResponseSuccess extends QueryCouponStockResponseCommon {
    /**
     * 代金券批次ID
     * @description 代金券批次Id
     * @example 1757
...
export declare type QueryCouponStockSuccess = SuccessT<QueryCouponStockResponseSuccess>;
export declare type QueryCouponStockFail = FailT<QueryCouponStockResponseFail>;
