...
export interface BatchQueryCommentResponseFail extends BatchQueryCommentResponseCommon {
}
export interface BatchQueryCommentResponseSuccess extends BatchQueryCommentResponseCommon {
}
export declare type BatchQueryCommentSuccess = SuccessT<BatchQueryCommentResponseSuccess>;
export declare type BatchQueryCommentFail = FailT<BatchQueryCommentResponseFail>;
