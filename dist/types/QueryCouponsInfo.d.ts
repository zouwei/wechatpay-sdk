...
export interface QueryCouponsInfoResponseSuccess extends QueryCouponsInfoResponseCommon {
    /**
     * 批次ID
     * @description 代金券批次Id
     * @example 1567
...
export declare type QueryCouponsInfoSuccess = SuccessT<QueryCouponsInfoResponseSuccess>;
export declare type QueryCouponsInfoFail = FailT<QueryCouponsInfoResponseFail>;
