...
export interface AuthCodeToOpenIdResponseSuccess extends AuthCodeToOpenIdResponseCommon {
    /**
     * 用户标识
...
export declare type AuthCodeToOpenIdSuccess = SuccessT<AuthCodeToOpenIdResponseSuccess>;
export declare type AuthCodeToOpenIdFail = FailT<AuthCodeToOpenIdResponseFail>;
